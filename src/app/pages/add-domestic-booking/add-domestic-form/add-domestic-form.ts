...
export class AddDomesticForm implements OnInit {
  ...
  bookingTypeControl = new FormControl('domestic'); // ค่าเริ่มต้นคือ domestic
  ...
  onSave() {
    ...
    const rawData = {
      ...
      deliveryDate: this.bookingForm.value.deliveryDate,
      deliveryTime: this.bookingForm.value.deliveryTime,
